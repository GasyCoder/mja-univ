...
<head>
    ...
    || Route::is('president') || Route::is('profil_etab') || Route::is('rubrique_etab') || Route::is('domaines')
...
<script data-navigate-track src="{{ asset('assets/vendor/purecounterjs/dist/purecounter_vanilla.js') }}"></script>
<script data-navigate-once src="{{ asset('assets/vendor/isotope/isotope.pkgd.min.js') }}"></script>
<script src="{{ asset('assets/vendor/tiny-slider/tiny-slider.js') }}"></script>
<script data-navigate-once src="{{ asset('assets/vendor/glightbox/js/glightbox.js') }}"></script>
<script data-navigate-once src="{{ asset('assets/vendor/simplebar/dist/simplebar.min.js') }}"></script>
<script data-navigate-once src="{{ asset('assets/vendor/imagesLoaded/imagesloaded.js') }}"></script>
<!-- Js Functions -->
@if(!Route::is('historiqueIndex'))
<script data-navigate-once src="{{ asset('assets/js/functions.js') }}"></script>
@else
