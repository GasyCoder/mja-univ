            ...
            <div class="d-flex align-items-center w-100">
                ...
                <div class="d-flex align-items-center d-xl-none">
                    <a class="navbar-brand" href="index.html">
                        <img class="light-mode-item navbar-brand-item h-30px" src="{{ asset('assets/images/logo-mobile.svg') }}"
                            alt="">
                        <img class="dark-mode-item navbar-brand-item h-30px" src="{{ asset('assets/images/logo-mobile-light.svg') }}"
                            alt="">
                    </a>
                </div>
                <!-- Logo END -->
                ...
                <div class="navbar-expand-lg ms-auto ms-xl-0">
                    ...
                    <div class="collapse navbar-collapse w-100" id="navbarTopContent">
                        <!-- Top search START -->
                        <div class="my-3 nav my-xl-0 flex-nowrap align-items-center">
                            <div class="nav-item w-100">
                                <form class="position-relative">
                                    <input class="border-0 form-control pe-5 bg-secondary bg-opacity-10" type="search"
                                        placeholder="Rechercher..." aria-label="Search">
                                    <button
                                        class="px-2 py-0 bg-transparent border-0 position-absolute top-50 end-0 translate-middle-y"
                ...
                <div class="ms-xl-auto">
                    <ul class="flex-row navbar-nav align-items-center">
                        ...
                        <li class="nav-item ms-2 ms-md-3 dropdown">
                            <!-- Notification button -->
                            <a class="mb-0 btn btn-light btn-round" href="#" role="button" data-bs-toggle="dropdown"
                            ...
                            <div
                                class="p-0 border-0 shadow-lg dropdown-menu dropdown-animation dropdown-menu-end dropdown-menu-size-md">
                                <div class="bg-transparent card">
                                    <div
                                        class="py-4 bg-transparent card-header border-bottom d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="p-0 card-body">
                                        <ul class="list-group list-unstyled list-group-flush">
                                            ...
                                            <li>
                                                <a href="#"
                                                    class="p-3 border-0 list-group-item-action border-bottom d-flex">
                                                    <div class="me-3">
                                                    ...
                                                    <div>
                                                        <p class="m-0 text-body small">Congratulate <b>Joan Wallace</b>
                                    ...
                                    <!-- Button -->
                                    <div class="py-3 text-center bg-transparent border-0 card-footer position-relative">
                        ...
                        <li class="nav-item ms-2 ms-md-3 dropdown">
                            <!-- Avatar -->
                            <a class="p-0 avatar avatar-sm" href="#" id="profileDropdown" role="button"
                            ...
                            <ul class="pt-3 shadow dropdown-menu dropdown-animation dropdown-menu-end"
                                ...
                                <!-- Links -->
                                <li>
                                    <a class="dropdown-item" href="#"><i class="bi bi-person fa-fw me-2"></i>
                                    Editer le profil</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="#"><i class="bi bi-gear fa-fw me-2"></i>
                                ...
                                <li>
                                    <div
                                        class="p-1 mt-2 rounded bg-light dark-mode-switch theme-icon-active d-flex align-items-center">
                                        <!-- <span>Mode:</span> -->
                                        <button type="button" class="mb-0 btn btn-sm" data-bs-theme-value="light">
                                        ...
                                        <button type="button" class="mb-0 btn btn-sm" data-bs-theme-value="dark">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        <button type="button" class="mb-0 btn btn-sm active" data-bs-theme-value="auto">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
