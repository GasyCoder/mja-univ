		...
		<div class="container">
			...
			<div class="navbar-collapse collapse" id="navbarCollapse">
				...
				<ul class="navbar-nav navbar-nav-scroll ms-auto">
					<!-- Nav item 1 Demos -->
					<li class="nav-item dropdown"><a class="nav-link" href="#">Pré-inscription</a></li>

					<!-- Nav item 2 Eduport Business -->
					<li class="nav-item dropdown"><a class="nav-link" href="#">Télécharger</a></li>
			...
			<div class="navbar-collapse w-100 collapse" id="navbarCollapse2">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link @if(request()->routeIs('historiqueIndex')
                                            ...
                                            || request()->routeIs('staff_page')) active @endif dropdown-toggle" href="#"
                        id="accounntMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="accounntMenu">
                        ...
                        <a class="dropdown-item @if(request()->routeIs('staff_page')) active @endif" href="{{ route('staff_page') }}"
                            wire:navigate>Staff & Leadership</a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="accounntMenu">
                        <a class="dropdown-item @if(request()->routeIs('doctoral')) active @endif" href="{{ route('doctoral') }}"
                            wire:navigate>Ecoles Doctorale</a>
