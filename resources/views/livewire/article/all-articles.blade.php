            ...
            @foreach($articles as $article)
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="bg-transparent card">
                        ...
                        <a href="{{ route('open_article', ['slug' => $article->slug]) }}" wire:navigate>
                            @php
                            $images = explode(',', $article->images);
                            @endphp
                            <img src="{{ asset('storage/' .$images[0]) }}" class="card-img" alt="{{ $article->category->name }}"
                        ...
                        <div class="card-body">
                            <!-- Title -->
                            <h6 class="card-title text-truncate-2"><a href="{{ route('open_article', ['slug' => $article->slug]) }}">{!! $article->title !!}</a></h6>
                            <p class="text-truncate-2">
                                {!! $article->sub_title !!}
                            </p>
                            <!-- Info -->
                            <div class="d-flex justify-content-between">
                                <a href="{{ route('open_article', ['slug' => $article->slug]) }}" wire:navigate class="text-primary">
