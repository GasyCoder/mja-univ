    ...
    <section class="bg-light">
        <div class="container">
            <div class="row position-relative">
                <!-- SVG decoration -->
                <figure class="top-0 position-absolute start-0 d-none d-sm-block">
                ...
                <div class="mx-auto text-center col-lg-10 position-relative">
                    ...
                    <!-- SVG decoration -->
                    <figure class="mt-3 position-absolute top-100 start-50 translate-middle ms-n9 d-none d-lg-block">
                        <svg>
                    ...
                    <div class="d-flex justify-content-center position-relative">
                        <nav aria-label="breadcrumb">
                            <ol class="mb-0 breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Mot du président</li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <section class="pt-5 pb-0">
        <div class="container">
            <div class="row g-0 g-lg-5">
                ...
                <div class="col-lg-4">
                    <div class="row">
                        <div class="col-md-6 col-lg-12">
                            ...
                            <div class="p-2 mb-4 text-center shadow card">
                                <div class="rounded-3">
                                    <!-- Image -->
                                    <img src="{{ asset('storage/' .$image_path) }}" class="card-img" alt="course image">
                                </div>
                                <!-- Card body -->
                                <div class="px-3 mt-3 card-body border-top">
                                    <h5 class="mb-0 h6 fw-bold">{{ $name }}</h5>
                                </div>
                                <p>Président en exercice - Année : 2022-2025</p>
                            </div>
                ...
                <!-- Main content START -->
                <div class="border col-lg-8 card">
                    <div class="card-body">
                        ...
                        <div class="mt-4 row g-3">
                            ...
                            <div class="col-sm-12 col-lg-12">
                                <div class="d-flex align-items-center">
                                    <span class="mb-0 icon-lg text-orange bg-orange bg-opacity-10 rounded-3"><i
                                            class="fas fa-trophy"></i></span>
                                    <div class="ms-3">
                                        <div class="d-flex">
                                            <h5 class="mb-0 purecounter fw-bold" data-purecounter-start="0"
                                                data-purecounter-end="11" data-purecounter-delay="200">0</h5>
                                            <sup class="mb-2 h6 fw-bold">ème</sup>
                                        </div>
                                        <p class="mb-0 h6 fw-light">Président de l'Université de Mahajanga</p>
                                    </div>
                                </div>
                            </div>
                        </div>
