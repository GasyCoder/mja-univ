        ...
        <div class="container pt-0 mt-0 mt-lg-2">
            ...
            <div class="pb-0 mb-0 row position-relative mb-sm-0 pb-lg-0">
                <div class="mx-auto text-center col-lg-8 position-relative">
                    ...
                    <p>Vous pouvez consulter les résultats en cliquant sur l'établissement de
                    votre choix. </p>
                </div>
            </div>
            <!-- Title and SVG END -->
            ...
            <div class="col-xl-3">
                <div class="mb-0 row">
                    <div class="col-md-6 col-xl-12">
                        <div class="p-3 overflow-hidden card bg-blue position-relative"
                            style="background:url(assets/images/pattern/05.png) no-repeat center center; background-size:cover;">
                            <!-- SVG decoration -->
                            <figure class="bottom-0 position-absolute end-0 mb-n4 d-none d-md-block">
                            ...
                            <div class="card-body">
                                <!-- Titre -->
                                <h5 class="mb-2 text-white card-title">
                                    Téléchargez nos documents
                                </h5>
                                <p class="text-white text-opacity-75">
                                    Vous avez la possibilité de télécharger la fiche de pré-inscription pour cette année universitaire.
                                </p>
                                <!-- Bouton -->
                                <a href="{{ route('documents') }}" class="mb-0 btn btn-sm btn-warning">Cliquez ici</a>
                            </div>
                        </div>
                    </div>
                </div><!-- Row End -->
