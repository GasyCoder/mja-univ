<!-- Action box START -->
<section class="py-0 mt-1 mb-4">
    <div class="container">
        <div class="row g-4">
            <!-- Action box item -->
            <div class="overflow-hidden col-lg-6 position-relative">
                <div class="p-5 bg-secondary bg-opacity-10 h-100">
                    <!-- Image -->
                    <div class="bottom-0 position-absolute end-0 me-3">
                       <img src="{{ asset('assets/images/element/doc.png') }}" class="h-100px h-sm-200px" alt="">
                    </div>
                    <!-- Content -->
                    <div class="row">
            ...
            <div class="overflow-hidden col-lg-6 position-relative">
                <div class="p-5 bg-secondary bg-opacity-10 h-100">
                    <!-- Image -->
                    <div class="bottom-0 position-absolute end-0 me-3">
                        <img src="{{ asset('assets/images/element/folder.png') }}" class="h-100px h-sm-200px" alt="">
                    </div>
                    <!-- Content -->
                    <div class="row">
                        <div class="col-sm-8 position-relative">
