                        ...
                        <div class="tiny-slider-inner" data-autoplay="true" data-gutter="80" data-arrow="true"
                           ...
                           <div>
                            <div class="px-1 py-2 text-center border bg-body rounded-2 position-relative">
                                <img src="{{ asset('storage/' .$domaine->icon_path) }}" class="h-40px"
                                    style="width: 40px; height: 40px; object-fit: cover;" alt="">
                                <a href="{{ route('detail_domaine', ['uuid' => $domaine->uuid]) }}"
                                    wire:navigate
                                    class="text-primary-hover stretched-link"><span class="h6 ms-2">{{ Str::limit($domaine->name, 12)
                                        }}</span>
                                </a>
                            </div>
                        </div>
