@if($mot->is_active ?? null)
<!-- ======================= About START -->
<section class="py-2 mt-0 pt-lg-2">
    <div class="container">
        <div class="row">
            <div class="col-12 position-relative z-index-1">
                <!-- Image -->
                <div class="bottom-0 d-none d-lg-block position-absolute start-0 ms-3 ms-xl-5 show">
                ...
                <div class="p-4 overflow-hidden shadow rounded-2 bg-light p-sm-5 position-relative z-index-n1">
                    ...
                    <figure class="position-absolute top-50 end-0 translate-middle-y">
                        <svg width="205.6px" height="396.1px">
