...
<div wire:ignore class="modal fade" id="editDoc" tabindex="-1" aria-labelledby="editDocLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-dark">
                <h5 class="text-white modal-title" id="editDocLabel">Modifier</h5>
                ...
                <form class="row text-start g-3" novalidate="" wire:submit.prevent="update">
                   ...
                   <div class="col-lg-6">
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control" wire:model="about" id="slogan" cols="10" rows="10"></textarea>
                    ...
                    @else
                        <img src="{{ public_path('storage/' . $logoCurrent) }}" width="50" height="50" style="line-height:25px">
                    @endif
                    </div>
                    ...
                    <div class="mt-3 col-md-12">
                        <div class="form-check form-switch form-check-md">
                            @if($status == true)
                            <input class="form-check-input" wire:model="status" checked type="checkbox" id="publish">
                            @else
