...
@if(!$openTrash)
    ...
    <div class="border page-content-wrapper">
        ...
        <div class="mb-3 row">
            <div class="col-12">
                <h3 class="mb-2 h3 mb-sm-0">Ecole doctorales <span class="badge bg-orange bg-opacity-10 text-orange">
                    {{ $doctorales->count() }}</span>
                </h3>
                <a href="#" wire:click="trash()" class="mb-0 btn btn-sm btn-dark">
                   <i class="bi bi-trash-fill"></i> Corbeille
                </a>
                <a href="#" class="mb-0 btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#addDoc">Nouvelle
                    Ecole doctorale</a>
            </div>
        </div>
        <!-- Card START -->
    ...
    @include('livewire.admin.etabs.doctorale.add')
    @include('livewire.admin.etabs.doctorale.edit')

    @include('livewire.admin.etabs.statistique.doctorale')

    @include('livewire.admin.etabs.contact.doctorale')

@else
@include('livewire.admin.etabs.doctorale.trash')
@endif
</div>
