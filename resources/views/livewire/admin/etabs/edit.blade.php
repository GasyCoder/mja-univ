...
<div wire:ignore class="modal fade" id="editEtab" tabindex="-1" aria-labelledby="editEtabLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-dark">
                <h5 class="text-white modal-title" id="editEtabLabel">Modifier</h5>
