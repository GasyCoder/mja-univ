<div>
    <!-- Page main content START -->
        <div class="border page-content-wrapper">
            ...
            <div class="mb-3 row">
                <div class="col-12">
                    <h3 class="mb-2 h3 mb-sm-0">Catégories Staff
                        <span class="badge bg-orange bg-opacity-10 text-orange">
                            {{ $categories->count() }}
                        </span>
                    </h3>
                    <a href="#" wire:click="cancel()" class="mb-0 btn btn-sm btn-danger">
                        ...
                        <table class="table p-4 mb-0 align-middle table-dark-gray table-hover">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="border-0">Staff</th>
                            ...
                            <tbody>
                             ...
                             @foreach($categories as $cat)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center position-relative">
                                            ...
                                            <h6 class="mb-0 table-responsive-title ms-2">
                                                <a href="#" class="stretched-link bg-opacity-15 text-primary">{{ $cat->title }}</a>
                                            </h6>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <!-- Table data -->
                                    <td> {{ $cat->staffs->count() }}</td>

                                    <!-- Table data -->
                                    <td>
                                        <a href="#" wire:click="editCat({{ $cat->id }})"
                                        ...
                                        wire:click="deleteCat({{ $cat->id }})">Supprimer</button>
                                    </td>
                                </tr>
                                @endforeach
...
@include('livewire.admin.universite.cates.add')
@include('livewire.admin.universite.cates.edit')
</div>
