...
<div wire:ignore class="modal fade" id="editStaff" tabindex="-1" aria-labelledby="editStaffLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-dark">
                <h5 class="text-white modal-title" id="editStaffLabel">Modifier</h5>
            ...
            <div class="modal-body">
                ...
                <form class="row text-start g-3" novalidate="" wire:submit.prevent="update">
                    ...
                    <div>
                        <img src="{{ asset('storage/' .$dbImage) }}" alt="image" width="40" height="40">
                    </div>
                    <!-- Switch -->
