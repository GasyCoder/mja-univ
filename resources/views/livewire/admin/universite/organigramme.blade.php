    ...
    <div class="border row g-2 page-content-wrapper col-xl-10 col-lg-10 col-md-12 col-12">
        ...
        <div class="shadow card">
            ...
            <div class="card-header">
                <h5 class="card-header-title">Organigramme</h5>
            </div>
            <!-- Card body START -->
            <div class="card-body">
                <form class="row g-4 align-items-center" wire:submit.prevent="update">
                    <div x-data="{ uploading: false, progress: 0 }" x-on:livewire-upload-start="uploading = true"
                        ...
                        <div class="col-12">
                            <div class="p-4 text-center border border-2 border-dashed justify-content-center align-items-center p-sm-5 position-relative rounded-3">
                                <!-- Image -->
                                <img src="{{ asset('assets/images/element/gallery.svg') }}" class="h-40px" alt="">
                                <div>
                                ...
                                @if ($image_path)
                                <img src="{{ $image_path->temporaryUrl() }}" width="200" height="150"
                                    style="line-height:25px">
                                @else
                                <img src="{{ asset('storage/' . $currentImage) }}" width="200" height="150"
                                    style="line-height:25px">
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="col-12" wire:ignore>
                        ...
                        <div>
                            <div style="height: 100%;">
                                <textarea class="form-control" rows="30" wire:model="body"></textarea>
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="mb-0 form-check form-switch form-check-lg">
                            ...
                            @else
                            <input class="mt-0 form-check-input price-toggle me-2" wire:model="is_active"
                                type="checkbox" id="flexSwitchCheckDefault">
                            @endif
