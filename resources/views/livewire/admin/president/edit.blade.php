...
<div wire:ignore class="modal fade" id="editStory" tabindex="-1" aria-labelledby="editStoryLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-dark">
                <h5 class="text-white modal-title" id="editStoryLabel">Modifier</h5>
            ...
            <div class="modal-body">
               <form class="row text-start g-3" novalidate="" wire:submit.prevent="update">
                    ...
                    <div class="col-12">
                        ...
                        <input class="form-control" type="text" wire:model="decret">
                        @error('decret') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="col-12">
                        <label class="form-label">Photo(s)</label>
                        <input class="form-control" type="file" wire:model="president_avatar">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="d-sm-flex">
                            ...
                            <div class="form-check radio-bg-light me-4">
                                <input class="form-check-input" type="radio" value="0" wire:model="is_interim" id="flexRadioDefault1"
                                    checked="">
                            ...
                            <!-- Radio -->
                            <div class="form-check radio-bg-light me-4">
                                <input class="form-check-input" type="radio" value="1" wire:model="is_interim" id="flexRadioDefault2">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="d-sm-flex">
                            <!-- Radio -->
                            <div class="form-check radio-bg-light me-4">
                                <input class="form-check-input" type="radio" value="0" wire:model="is_dead" id="flexRadioDefault1"
                                    checked="">
                                <label class="form-check-label" for="flexRadioDefault1">
                                    Non
                                </label>
                            ...
                            <!-- Radio -->
                            <div class="form-check radio-bg-light me-4">
                                <input class="form-check-input" type="radio" value="1" wire:model="is_dead" id="flexRadioDefault2">
                                <label class="form-check-label" for="flexRadioDefault2">
                                    Oui
                                </label>
                            </div>
