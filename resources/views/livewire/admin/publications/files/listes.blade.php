            ...
            <table class="table p-4 mb-0 align-middle table-dark-gray table-hover">
                ...
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="border-0">Fichier</th>
                        <th scope="col" class="border-0">Pages</th>
                        <th scope="col" class="border-0">Revue</th>
                        <th scope="col" class="border-0">ISSN</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ asset('storage/' . $file->file_path) }}" target="_blank" class="d-flex align-items-center">
                                {{ Str::limit($file->original_name, 20) }}
                            </a>
                        </td>
                        <td>
                            <div class="d-flex align-items-center">
                                p.{{ $file->startPage. '-' .$file->endPage }}
                            </div>
                        </td>
                        <td>
                            <div class="d-flex align-items-center">
                                {{ $file->revue->sigle }}/{{ $file->annee->annee }}/{{ $file->volume->volumeName }}
                            </div>
                        </td>
                        <td>
                            <div class="d-flex align-items-center">
                        ...
                        <td>
                            <a href="#" wire:click="edit({{ $file->id }})"
                                ...
                                data-bs-toggle="modal" data-bs-target="#editFile">
