    ...
    <div class="border page-content-wrapper">
        ...
        <div class="mb-2 row">
            <div class="col-12 d-flex justify-content-between align-items-center">
                @if(!$openTrash)
                <h3 class="mb-2 h3 mb-sm-0">Documents Télécharger
                ...
                <div>
                    <a href="#" class="mt-3 mb-0 btn btn-sm btn-primary" data-bs-toggle="modal"
                        data-bs-target="#uploader">Uploader</a>
        ...
        @if(!$openTrash)
        @include('livewire.admin.upload.listes')
        @else
        @include('livewire.admin.upload.trash')
        @endif

    </div>
    <!-- Page main content END -->
    @include('livewire.admin.upload.add')
    @include('livewire.admin.upload.edit')
</div>
