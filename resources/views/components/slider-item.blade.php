                   ...
                   <h1 class="mb-0 text-white display-8">
                        <span class="position-relative">{{ Str::limit($slider->title, 38) }}
                            ...
                            <span class="position-absolute top-50 start-50 translate-middle ms-4 z-index-n1">
                                <svg width="266px" height="50.1px" enable-background="new 0 0 366 62.1" viewbox="0 0 366 62.1"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path class="fill-{{$slider->bg_color}}"
                    ...
                    <!-- Button -->
                    <a href="{{ route('open_article', ['slug' => $slider->slug]) }}" class="mb-0 btn btn-sm btn-{{$slider->bg_color}}">En savoir plus</a>
                </div>
            </div>
        </div>
    </div>
